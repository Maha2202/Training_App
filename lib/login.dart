                ...
                children: <Widget>[
                  ...
                  FlatButton(
                    child: Text("هل نسيت كلمة المرور ؟",
                      style: TextStyle(color: Colors.black,fontFamily: 'Tajawal', decoration: TextDecoration.underline,)),
                    onPressed: (){
                        ...
                        children: <Widget>[
                          SizedBox(height: 60,
                              ...
                              child: ElevatedButton(
                                child: Text('تسجيل الدخول',style: TextStyle(fontSize: 15,fontFamily: 'Tajawal'),),
                      ...
                      child: Column(
                        children: <Widget>[
                          SizedBox(height: 60,
                              width: MediaQuery.of(context).size.width,
                              child: ElevatedButton(
                                  child: Text('إنشاء حساب',style: TextStyle(fontSize: 15,fontFamily: 'Tajawal'),),
                                  style: ElevatedButton.styleFrom(primary: Color.fromARGB(255, 61, 213, 152),onPrimary: Colors.white,elevation: 10,
                                      shape: RoundedRectangleBorder(
                                        borderRadius: BorderRadius.circular(50.0),
                                      )),
